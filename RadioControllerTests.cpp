...
using Transitions = M::Transitions<
    Transition<Idle, Listening, EVT_START_LISTENING, LogT<"action:start-listening">>,
    Transition<Listening, Configuring, EVT_CONFIGURE, LogT<"action:configure">>,
    Transition<SetFrequency, SetPower, EVT_CONFIG_STEP, LogT<"action:config-step1">>,
    Transition<SetPower, SetSpreadingFactor, EVT_CONFIG_STEP, LogT<"action:config-step2">>,
    Transition<SetSpreadingFactor, Listening, EVT_CONFIG_DONE, LogT<"action:config-done">>,
    Transition<Configuring, Listening, EVT_INTERRUPT_CONFIG, LogT<"action:interrupt-config">>,
    InternalTransition<Configuring, EVT_LOG_CONFIG, LogConfigTransition>,
    InternalTransition<RootState, EVT_HEARTBEAT, HeartbeatTransition>,
    Transition<Listening, Transmitting, EVT_SEND_REQUEST, LogT<"action:send-request">>,
    Transition<Preparing, Sending, EVT_PACKET_READY, LogT<"action:packet-ready">>,
    Transition<Sending, AwaitingAck, EVT_SENT, LogT<"action:sent">>,
    Transition<AwaitingAck, Listening, EVT_ACK_RECEIVED, AckReceivedTransition>,
    Transition<AwaitingAck, Sending, EVT_ACK_TIMEOUT, AckTimeoutRetryTransition>,
    Transition<Transmitting, Idle, EVT_ACK_TIMEOUT, LogT<"action:give-up">>,
    Transition<AwaitingAck, AwaitingAck, EVT_RECALIBRATE, RecalibrateTransition>,
    Transition<AwaitingAck, Critical, EVT_EMERGENCY, EmergencyLeafTransition>,
    Transition<Transmitting, Recoverable, EVT_EMERGENCY, EmergencyMidTransition>,
    Transition<RootState, Recoverable, EVT_EMERGENCY, LogT<"action:emergency-recoverable-root">>,
    Transition<Recoverable, Transmitting, EVT_RESET, LogT<"action:reset-resume">, transition_kind::deep>,
    Transition<Critical, Recoverable, EVT_RESET, LogT<"action:should-never-fire", false>>,
    Transition<Idle, Sleep, EVT_TIMEOUT, TimeoutT<false, "action:timeout-from-idle">>,
    Transition<Active, Sleep, EVT_TIMEOUT, TimeoutT<true, "action:timeout-from-active">>,
    Transition<Sleep, Idle, EVT_WAKE_UP, WasActiveGuardT<false, "action:wakeup-idle">>,
    Transition<Sleep, Active, EVT_WAKE_UP, WasActiveGuardT<true, "action:wakeup-active-deep">, transition_kind::deep>,
    Transition<Sleep, Idle, EVT_SOFT_RESET, WasActiveGuardT<false, "action:softreset-idle">>,
    Transition<Sleep, Active, EVT_SOFT_RESET, WasActiveGuardT<true, "action:softreset-active-shallow">,
